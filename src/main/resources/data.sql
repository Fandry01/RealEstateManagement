...
UPDATE tenants SET complaint_id = 1 WHERE username = 'mark';
UPDATE properties SET investor_username = 'jan' WHERE id = 1;
UPDATE tenants SET property_id = 1 WHERE username = 'mark';